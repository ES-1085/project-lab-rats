...
corruption_1 <-  ggplot(whr_2, aes(x = as.numeric(perceptions_of_corruption), y = happiness_score)) +
  geom_point(alpha = 0.5) +
  geom_smooth(method = "lm", aes(group = year)) +
...
corruption_2 <- animate(corruption_1, nframes = 5, fps = 1.5, renderer = gifski_renderer())
anim_save(filename = "corruption_happiness.gif")
```
...
suicide_2 %>%
  ...
  scale_fill_viridis_d() +
   labs(x = "Year",
       y = "Suicide Rates",
       title = "Suicide Rates of Portugal By Year (Organized by Sex)")
...
suicide_2 %>%
  ...
  scale_fill_viridis_d() +
   labs(x = "Year",
       y = "Suicide Rates",
       title = "Suicide Rates of China By Year (Organized by Sex)")
...
suicide_2 %>%
  ...
  scale_fill_viridis_d() +
   labs(x = "Year",
       y = "Suicide Rates",
       title = "Suicide Rates of Brazil By Year (Organized by Sex)")
```
...
suicide_2 %>%
  ...
  scale_fill_viridis_d() +
   labs(x = "Year",
       y = "Suicide Rates",
       title = "Suicide Rates of Costa Rica By Year (Organized by Sex)")
```
...
suicide_2 %>%
  ...
  scale_fill_viridis_d() +
   labs(x = "Year",
       y = "Suicide Rates",
       title = "Suicide Rates of Israel By Year (Organized by Sex)")
```
...
suicide_2 %>%
  ...
  scale_fill_viridis_d() +
   labs(x = "Year",
       y = "Suicide Rates",
       title = "Suicide Rates of Mexico By Year (Organized by Sex)")
```
...
suicide_2 %>%
  ...
  scale_fill_viridis_d() +
   labs(x = "Year",
       y = "Suicide Rates",
       title = "Suicide Rates of New Zealand By Year (Organized by Sex)")
```
