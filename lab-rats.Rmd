...
```{r whr-gdp-happiness, fig.alt= "This gif shows the correlation between GDP per capita and happiness score from 2015 through 2019 in the World Happiness Report. The two variables have a positive correlation. That means higher GDP per capita correlates with higher happiness scores." }
...
```{r whr-life-expectancy-happiness, fig.alt= "This gif shows the correlation between life expectancy and happiness score from 2015 through 2019 in the World Happiness Report. The two variables have a positive correlation. This means that longer life expectancies usually correlate with higher happiness scores."}
...
```{r whr-freedom-happiness, fig.alt= "This gif shows the correlation between freedom ratings and the happiness score from 2015 through 2019 in the World Happiness Report. The two variables have a positive correlation. This means that more freedom usually correlates with higher happiness scores."}
...
perceptions_of_corruption_1 <- ggplot(whr_2, aes(x = as.numeric(perceptions_of_corruption), y = happiness_score)) +
  ...
  theme(
    ...
    axis.title = element_text(size = 17, face = "bold", hjust = 0.5),
    plot.background = element_rect(fill = "white")
  ) +
...
suicide_anim <- suicide_2 %>%
  ...
  labs(x = "GDP per capita", y = "Suicide Rates", color = "WHR Happiness Score",
...
suicide_2 %>%
  ...
  labs(title = "Collective Suicide Rates of Randomly Selected Countries",
       subtitle = "By Sex") +
      jpeg(filename = "suicide-violin.jpep")
...
#     colors = c ("#000004FF", "#450A69FF", "#85216BFF","#CF4446FF","#F1731DFF", "#FBB61AFF","#F2F27DFF"),
