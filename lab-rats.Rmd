...
ggplot(whr_2, aes(x = as.factor(perceptions_of_corruption), y = happiness_score, group = year)) +
  geom_point(alpha = 0.5) +
...
#anim2 <- animate(anim1, nframes = 5, fps = 1, renderer = gifski_renderer())
anim_save(filename = "anim2.gif", anim2)
```
