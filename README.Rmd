...
<<<<<<< HEAD
  ggplot() +
  geom_point(aes(x = gdp_per_capita, y = happiness_score)) +
  geom_smooth(aes(x = gdp_per_capita, y = happiness_score), method = "lm") +
...
>>>>>>> 854825234f2f25e151062d5e97642a0f0012fe0b
  facet_wrap(~ year, ncol = 2)
```
...
ggplot() +
  #geom_point(aes(x = gdp_per_capita, y = suicide_rates)) +
  geom_miss_point(aes(x = gdp_per_capita, y = suicide_rates, color= happiness_score), alpha = 0.5) +
  geom_smooth(aes(x = gdp_per_capita, y = suicide_rates), method = "lm") +
  labs(x = "GDP per capita", y = "Suicide Rates", title = "Correlation between GDP per capita and Suicide Rates (WHR 2015-2019)") +
  facet_wrap(~ year, ncol = 2) +
